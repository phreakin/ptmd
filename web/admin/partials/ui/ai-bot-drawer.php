<aside class="ptmd-drawer" id="ptmdAiBotDrawer" aria-label="The Analyst Drawer" aria-hidden="true">
    <div class="ptmd-drawer__panel glass-modal ptmd-ai-bot">
        <div class="d-flex justify-content-between align-items-start">
            ...
            <button class="btn btn-ptmd-ghost btn-sm" type="button" data-drawer-close><i class="fa-solid fa-xmark"></i></button>
        </div>
        <div class="ptmd-stack-sm" style="overflow:auto;max-height:45vh">
            ...
            <article class="glass-card p-3 ptmd-stack-sm">
                ...
                <article class="ptmd-state-card">
                    ...
                    <p>Promote contradiction #2 into hook opener; expected retention uplift +6–10%.</p>
                </article>
                <article class="ptmd-state-card">
                    <h4>Why this recommendation</h4>
                    <p>Conflict language historically improves first-5-second hold rate for this case category.</p>
                </article>
                <div class="ptmd-ai-citations">
                    <a href="#">Doc 14 / Deposition 2</a>
                    <a href="#">Transcript 9:14-9:37</a>
                    <a href="#">Hook cohort analytics / Similar Case Set B</a>
                </div>
            </article>
