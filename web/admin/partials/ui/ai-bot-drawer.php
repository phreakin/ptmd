<aside class="ptmd-drawer" id="ptmdAiBotDrawer" aria-label="The Analyst Drawer" aria-hidden="true">
    <div class="ptmd-drawer__panel glass-modal ptmd-ai-bot">
        ...
        <div class="ptmd-stack-sm" style="overflow:auto;max-height:45vh">
            ...
            <article class="glass-card p-3"><div class="small ptmd-muted mb-1">The Analyst</div><p class="mb-2">Three timeline conflicts were detected from source filings.</p><div class="ptmd-ai-citations"><a href="#">Doc 14 / Deposition 2</a><a href="#">Transcript 9:14-9:37</a></div></article>
        </div>
