...
CREATE TABLE IF NOT EXISTS episodes (
    ...
    intro_asset_path  VARCHAR(255)  NULL,   -- intro video; NULL falls back to site_settings
    outro_asset_path  VARCHAR(255)  NULL,   -- outro video; NULL falls back to site_settings
...
-- ------------------------------------------------------------
-- Episode Overlay Triggers  (time-synced overlays per episode)
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS episode_overlay_triggers (
    ...
    timestamp_out   DECIMAL(10,3)  NOT NULL DEFAULT 0.000,
...
-- ------------------------------------------------------------
-- Export Profiles  (platform-specific render presets)
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS export_profiles (
    ...
    use_triggers       TINYINT(1)    NOT NULL DEFAULT 1,
    extra_ffmpeg_flags TEXT          NULL,
...
-- ------------------------------------------------------------
-- Export Jobs  (render run history per episode+profile)
-- ------------------------------------------------------------
